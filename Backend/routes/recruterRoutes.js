...
const { recruiterRegister, recruiterLogin,getMyProfile } = require("../controllers/recruterControllers");
const {createJob,listMyJobs, updateJob, deleteJob} = require("../controllers/jobsController");
