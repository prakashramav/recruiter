            ...
            <ul className="interviews-list">
              {interviews.map((iv) => (
                <li key={iv._id} className="interview-card">
                  <h3>{iv?.applicantId?.name || "Unknown Applicant"}</h3>

                  <p>
                    <strong>Email:</strong>{" "}
                    {iv?.applicantId?.email || "N/A"}
                  </p>
                  ...
                  {iv?.meetLink ? (
                    ...
                    <p className="note">No meeting link added</p>
                  )}
